    ...
    >
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <h2 className="section-title mb-3">Síguenos y mantente informado</h2>
          <p className="section-subtitle max-w-lg mx-auto">
            Comparto consejos de salud, novedades médicas y contenido de
            bienestar en mis redes sociales.
          </p>
        </motion.div>
          ...
          {socials.map((social, i) => (
            ...
            >
              ...
              <div className="text-center">
                <p className="font-bold text-slate-800">{social.name}</p>
